...
const kpiCards = [
  { label: "Total Requests", value: "178+", color: "#0057b8", spark: wave(50, 20, 10, 1) },
  { label: "Completed Requests", value: "178+", color: "#e5484d", spark: wave(45, 22, 10, 2) },
  { label: "Average Response Time", value: "10 minutes", color: "#0057b8", spark: wave(55, 18, 10, 3) },
  { label: "Pending Requests", value: "178+", color: "#0057b8", spark: wave(40, 20, 10, 4) },
  { label: "In-Progress Requests", value: "178+", color: "#0057b8", spark: wave(48, 20, 10, 5) },
  { label: "Average Resolution Time", value: "30 minutes", color: "#e5484d", spark: wave(42, 18, 10, 6) },
  { label: "Cancelled Requests", value: "30", color: "#0057b8", spark: wave(38, 16, 10, 7) },
  { label: "Repeated Requests", value: "30", color: "#0057b8", spark: wave(52, 20, 10, 8) },
]
    ...
    <div className="rounded-xl p-4 bg-white shadow-sm border" style={{ borderColor: "#eaecf3" }}>
      <div className="flex items-start gap-3">
        ...
        <div>
          ...
          <p className="text-[11px] mt-0.5" style={{ color: "#8b94b2" }}>{label}</p>
        </div>
      </div>
      <div className="mt-2">
  ...
  return (
    <div className="flex flex-col gap-5 mt-6 px-2">
      ...
      <p className="text-sm font-semibold" style={{ color: "#2d3452" }}>
        {tab === "assist" ? "Assist Service Performance Metrics" : "Chatflow Performance Metrics"}
      </p>
